...
var sendVerify = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, _a, success, load;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                user = res.locals.user;
                return [4 /*yield*/, model.select(user.email)];
            case 1:
                ...
                if (user.verified || load.verified) {
