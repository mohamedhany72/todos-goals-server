...
var changePswd = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var oldUser, oldPswd, pswd, cpswd, result, user, match, success;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                oldUser = res.locals.user;
                oldPswd = req.body.opswd;
                pswd = req.body.pswd;
                cpswd = req.body.cpswd;
                return [4 /*yield*/, model.select(oldUser.email)];
            case 1:
                result = _a.sent();
                user = result.load;
                if (!result.success) {
                ...
                return [4 /*yield*/, bcrypt_1.default.compare(oldPswd + pepper, user.password)];
            case 2:
                match = _a.sent();
                if (!match) {
                ...
                return [4 /*yield*/, model.changePassword(user.id, cpswd)];
            case 3:
