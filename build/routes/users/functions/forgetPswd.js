...
var forgetPswd = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var email, _a, success, load, user, pswdToken;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                pswdToken = (0, createTokens_1.createPswdToken)(user.id);
                // send email to user
