...
var goals = express_1.default.Router();
var getGoals = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var addGoal = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, goal, _a, success, load;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                user = res.locals.user;
...
var deleteGoal = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, id, _a, success, load, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                user = res.locals.user;
